...
public class CashPurchaseActivity extends ActionBarActivity {
    ...
    protected void onStart() {
        ...
        {
            startActivity(new Intent(CashPurchaseActivity.this, MerchantLogin.class));
        }
    ...
    {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(CashPurchaseActivity.this);
    ...
    private void success(User returnedUser)
    {
        ...
        Intent confPurchase = new Intent(CashPurchaseActivity.this, confCashPurchaseActivity.class);
