...
$stmt=$conn->query("SELECT * FROM users WHERE account= '$accountNo' AND pin= '$pin' AND balance >= '$amount'");
...
/************************************/
//update table users
$stmt2=$conn->query("UPDATE users SET balance = '$balance', points = '$totalPoints' WHERE account = '$accountNo' AND pin = '$pin'");
...
VALUES  ('$accountNo', '$successName', '$amount', '$newPoints', '$datetime_formatted', '$merchName', 'Card')");
...
$message    = "You have purchased goods worth ".$amount.", and gained ".$newPoints." points. Your new account balance is ".$balance.", your new points balance is ".$totalPoints."";
