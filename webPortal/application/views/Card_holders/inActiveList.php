...
function activate(id){
  bootbox.confirm("Are you sure you want to activate this card? ", function(result) {
      if(result) {
      
    $.ajax({
    url: '<?php echo base_url(); ?>Card_holders/activate/' + id,
    type: 'post',
    data: {id: id},
    dataType: 'html',   
    success: function(html) {
        bootbox.alert(html);
        if(html == 'Card Activated')
        location.reload();
    }
  });
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Inactive Holders</h3>
                  <div class="box-tools">
                ...
                <tr>
                    ...
                    <td>
                      <a href="javascript:void(0);" onclick="activate('<?php echo $cardholder->id ;?>')">
                    <span class="btn btn-primary"><span class="fa fa-check"></span>&nbsp;Activate</span></a>
                    </td>
